...
BASE_DIR = 'D:/Jupyter Notebook/Data mining Final Project/BERT'
...
flags.DEFINE_string(
    "bert_config_file", BASE_DIR + '/cased_L-12_H-768_A-12/bert_config.json',
    "The config json file corresponding to the pre-trained BERT model. "
    "This specifies the model architecture.")

flags.DEFINE_string("task_name", "MRPC", "The name of the task to train.")

flags.DEFINE_string("vocab_file", BASE_DIR + '/cased_L-12_H-768_A-12/vocab.txt',
...
flags.DEFINE_string(
    "init_checkpoint", BASE_DIR + '/cased_L-12_H-768_A-12/bert_model.ckpt.index',
...
def main(_):
    ...
    if FLAGS.do_eval:
        eval_examples, eval_labels, temp = processor.get_dev_examples(FLAGS.data_dir)
        eval_file = os.path.join(FLAGS.output_dir, "eval.tf_record")
        label_map_dev = file_based_convert_examples_to_features(
    ...
    if FLAGS.do_predict:
        predict_examples, truth_labels, placeholder_labels = processor.get_test_examples(FLAGS.data_dir)
        predict_file = os.path.join(FLAGS.output_dir, "predict.tf_record")

        label_list_test = processor.get_labels(placeholder_labels)

        # example to features and then serialise to string and put into file
        label_map_test = file_based_convert_examples_to_features(predict_examples, label_list_test,
